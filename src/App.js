      ...
      <Container className='mt-5'>
          ...
          <Row className="justify-content-md-center">
            <Col className='text-center shadow-lg p-3 mb-4 bg-body rounded-3'>
              <h2>Cuadro grande</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec diam risus. Nullam semper vulputate ipsum, nec faucibus nibh ultricies eget. Proin at lectus felis. Sed nec tempor purus. Quisque a efficitur libero. In hac habitasse platea dictumst. Vestibulum ac ultrices risus. Vestibulum placerat elementum sollicitudin.</p>
              <p>Phasellus quis massa id libero posuere consectetur id ac mi. Praesent ut condimentum diam. Suspendisse eget odio vitae justo gravida bibendum sed eget ex. Fusce sodales, arcu eu vehicula rhoncus, massa ante varius dolor, et laoreet enim nisl a nisi. In sit amet tellus in lorem dapibus posuere. Cras purus metus, aliquet sit amet venenatis id, varius quis metus.</p>
            </Col>
          </Row>
        </Container>
